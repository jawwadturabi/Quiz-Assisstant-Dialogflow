...
exports.gk = async (agent) => {
    ...
    if (!opt && !ask) {
        ...
        await Model1.find({}).then(data => {
            agent.add(`You said option ${opt} . Here is your next question.${data[0].Question[i2]} `)
            agent.setContext({
                name: "abc",
                lifespan: 5,
                "parameters": {
        ...
        await Model1.find({}).then(data => {
            agent.add(`You said option ${opt}. Here is your next question.${data[0].Question[i3]} `)
            agent.setContext({
                name: "abc",
                lifespan: 5,
                "parameters": {
        ...
        await Model1.find({}).then(data => {
            agent.add(`You said option ${opt}.Here is your next question.${data[0].Question[i4]} `)
            agent.setContext({
                name: "abc",
                lifespan: 5,
                "parameters": {
        ...
        await Model1.find({}).then(data => {
            agent.add(`You said option ${opt}.Here is your next question.${data[0].Question[i5]}`)
            agent.setContext({
                name: "abc",
                lifespan: 5,
                "parameters": {
        ...
        await Model1.find({}).then(data => {
            agent.add(`You said option ${opt}.Here is your next question.${data[0].Question[i6]}`)
            agent.setContext({
                name: "abc",
                lifespan: 5,
                "parameters": {
        ...
        await Model1.find({}).then(data => {
            agent.add(`You said option ${opt}.Here is your next question.${data[0].Question[i7]}`)
            agent.setContext({
                name: "abc",
                lifespan: 5,
                "parameters": {
